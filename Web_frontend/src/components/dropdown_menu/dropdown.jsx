  ...
  return (
    ...
    <NavigationMenu.Root className="NavigationMenuRoot">
      <NavigationMenu.List className="NavigationMenuList">
        ...
        <NavigationMenu.Item>
          <NavigationMenu.Trigger className="NavigationMenuTrigger">
            Info <CaretDownIcon className="CaretDown" aria-hidden />
          </NavigationMenu.Trigger>
          <NavigationMenu.Content className="NavigationMenuContent">
            <ul className="List two">
              <ListItem title="Mayday Fires Data" href="/primitives/docs/overview/introduction">
              Real time & full lifecycle event intelligence, powered AI based data fusion.
              </ListItem>
              <ListItem title="NASA FIRMS Data" href="/primitives/docs/overview/getting-started">
                A quick tutorial to get you up and running with Radix Primitives.
              </ListItem>
              <ListItem title="NWS Weather Alerts" href="/primitives/docs/guides/styling">
                Unstyled and compatible with any styling solution.
              </ListItem>
              <ListItem title="USGS Earthquakes" href="/primitives/docs/guides/animation">
        ...
        <NavigationMenu.Item>
          <NavigationMenu.Link className="NavigationMenuLink" href="https://mayday.ai">
            Mayday.ai™
          </NavigationMenu.Link>
        </NavigationMenu.Item>
