          ...
          <NavigationMenu.Item>
            ...
            <NavigationMenu.Content className="NavigationMenuContent">
              <ul className="List two">
                <ListItem
                  title="Mayday Fires Data"
                  href="/primitives/docs/overview/introduction"
                >
                  Real time & full lifecycle event intelligence, powered AI
                  based data fusion.
                </ListItem>
                <ListItem
      ...
      {isPopupVisible && (
        <div style={popupStyle}>
          ...
          <video style={{ width: "100%", height: "100%" }} controls>
            <source
              src="https://geos-stat1.s3.us-east-2.amazonaws.com/G16/FULL/terra/Last24hrs.mp4"
              type="video/mp4"
              controls
              autoPlay
              muted
